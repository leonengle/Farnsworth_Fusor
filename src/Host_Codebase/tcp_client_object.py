...
class TCPClientObject:
    ...
    def send_actuator_command(self, actuator_name: str, actuator_value: float, actuator_label: str):
        ...
        logger.debug(f"TCP Client Object: Actuator {actuator_name} (label: {actuator_label}, hex: {actuator_info['label_hex']}) -> value: {actuator_value} -> command: {command} -> response: {response}")
