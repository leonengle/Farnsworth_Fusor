...
class TestUDPCommunication(unittest.TestCase):
    ...
    def test_udp_send_receive(self):
        ...
        sender_sock.sendto(test_message.encode('utf-8'), 
                          (self.test_host, self.test_port_receive))
    ...
    def test_udp_bidirectional(self):
        ...
        message1 = "MESSAGE_1"
        sock2.sendto(message1.encode('utf-8'), 
                     (self.test_host, self.test_port_receive))
        ...
        message2 = "MESSAGE_2"
        sock1.sendto(message2.encode('utf-8'), 
                     (self.test_host, self.test_port_send))
    ...
    def test_udp_multiple_messages(self):
        ...
        for msg in messages:
            sender_sock.sendto(msg.encode('utf-8'), 
                              (self.test_host, self.test_port_receive))
            time.sleep(0.1)
