...
def print_diagram_rich():
    ...
    console.print(
        Panel(
            orchestrator_text,
            border_style="yellow",
            title="[yellow]target_main.py[/yellow]",
        )
    )
    ...
    comm_table.add_row(
        "TCP Command Server", "2222", "Receives commands from host system"
    )
    ...
    proc_table.add_row(
        "Command Processor", "Parses and routes commands to hardware handlers"
    )
    proc_table.add_row(
        "Data Callback Handler", "Manages periodic data collection and transmission"
    )
    ...
    hw_table.add_row(
        "GPIO Pins", "LED Pin: 26 (Output), Input Pin: 6 (Input with PUD_DOWN)"
    )
    ...
    flow_text2.append(" -> ", style="yellow")
    flow_text2.append(
        "TCP Data Server (12345) / UDP Status Sender (8888)", style="green"
    )
    flow_text2.append(" -> ", style="yellow")
...
def print_diagram_colorama():
    ...
    print(
        ...
        + " (Port 2222)"
        + Fore.WHITE
        + " - Receives commands from host system"
    )
    print(
        Fore.CYAN
        + "TCP Data Server"
    ...
    print(
        ...
        + "Command Processor"
        + Fore.WHITE
        + " - Parses and routes commands to hardware handlers"
    )
    print(
        Fore.CYAN
        + "Data Callback Handler"
        + Fore.WHITE
        + " - Manages periodic data collection and transmission"
    )
    print()
    ...
    print(
        ...
        + "GPIO Pins"
        + Fore.WHITE
        + " - LED Pin: 26 (Output), Input Pin: 6 (Input with PUD_DOWN)"
    )
    print(
        Fore.CYAN
        + "MCP3008 ADC Chip"
        + Fore.WHITE
        + " - 8-channel, 10-bit ADC via SPI interface"
    )
    print()
    ...
    print(
        ...
        + " -> "
        + Fore.GREEN
        + "TCP Data Server (12345) / UDP Status Sender (8888)"
        + Fore.YELLOW
        + " -> "
        + Fore.WHITE
        + Style.BRIGHT
...
def print_diagram_plain():
    ...
    print("-" * 90 + "\n")
    print(
        "Host System -> TCP Command Server (2222) -> Command Processor -> GPIO Handler / ADC Interface -> Hardware"
    )
    print(
        "Hardware -> ADC Interface / GPIO Handler -> Data Callback Handler -> TCP Data Server (12345) / UDP Status Sender (8888) -> Host System"
    )
    print()
    print("=" * 90)
